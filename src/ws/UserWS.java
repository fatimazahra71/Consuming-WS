 ...
 * 
 */
@WebServiceClient(name = "userWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8686/UserService?wsdl")
public class UserWS
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8686/UserService?wsdl");
